...
AIC(mod1,mod2)
#l'AIC le plus faible est plus le modèle 1 donc on conserve le modèle 1

#Le modèle 1 expliqe mieux le coeffcient de diffusion que le modèle 2
summary(mod1)
